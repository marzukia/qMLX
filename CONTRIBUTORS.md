...
- **Andryo Marzuki** ([@marzukia](https://github.com/marzukia)) - qMLX fork: hybrid-aware disk KV restore, matchable-aware eviction, phase-split metrics, divergence logging, Qwen specialisation.
...
Portions of the model code are derived from Apple's
