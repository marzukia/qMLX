...
"""Submission flow for ``qmlx bench --submit``.
...
UPSTREAM_OWNER_REPO = "raullenchai/qmlx"
...
def _pr_body(payload: dict) -> str:
    ...
    return (
        ...
        f"- **notes**: {notes}\n\n"
        f"Auto-generated by `qmlx bench --submit`. The full payload "
