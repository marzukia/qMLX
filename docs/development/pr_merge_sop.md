...
- **Cache contamination** — disk-persisted prefix cache (`~/.cache/qmlx/prefix_cache/`) can replay cached generations and pin TPS to bogus values. Bench tools must pass `--disable-prefix-cache`.
