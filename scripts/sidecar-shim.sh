#!/bin/sh
#
# sidecar-shim.sh — entrypoint for the bundled qmlx sidecar.
# Installed as $STAGE/bin/qmlx by scripts/build-sidecar.sh.
#
...
# then exec the bundled python against the qmlx CLI module.
#
...
# bin/qmlx → bundled qmlx still finds the bundled python
