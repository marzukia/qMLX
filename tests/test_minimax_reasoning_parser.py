...
class TestTransitionDetection:
    ...
    def test_no_transition_double_newline_fallback(self):
        ...
        parser = MiniMaxReasoningParser()
        output = "The user asks about Python.\n\nPython is a great language for beginners."
...
class TestStreamingBasic:
    ...
    def test_direct_content_tool_call(self):
        ...
        result = parser.extract_reasoning_streaming("", "<minimax:tool_call>", "<minimax:tool_call>")
        assert result is not None
...
class TestStreamingThinkTags:
    ...
    def test_think_tag_with_content(self):
        ...
        result = parser.extract_reasoning_streaming("", "<think>reasoning", "<think>reasoning")
        assert result is not None
    ...
    def test_think_tag_end(self):
        ...
        # Add reasoning
        parser.extract_reasoning_streaming("<think>", "<think>some reasoning", "some reasoning")
    ...
    def test_think_tag_end_no_content(self):
        ...
        parser.extract_reasoning_streaming("", "<think>", "<think>")
        result = parser.extract_reasoning_streaming("<think>", "<think></think>", "</think>")
...
class TestStreamingTransition:
    ...
    def test_post_decision_content_passthrough(self):
        ...
        result = parser.extract_reasoning_streaming("```python", "```python\nprint", "\nprint")
        assert result is not None
        assert result.content == "\nprint"
...
class TestEdgeCases:
    ...
    def test_reset_between_streams(self):
        ...
        # First stream
        parser.extract_reasoning_streaming("", "<think>stuff</think>content", "<think>stuff</think>content")
        assert parser._decided is True
